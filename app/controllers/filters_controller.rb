class FiltersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @filter.save and @filter.update_manipulations(params[:manipulations])
  ...
  def update
    ...
    respond_to do |format|
      if @filter.update_attributes(params[:filter]) and @filter.update_manipulations(params[:manipulations])
